...
const i18n = {
  ru: {
    ...
    "about.desc": "Farabi Tech Hub — первый университетский бизнес-инкубатор в Казахстане, созданный при КазНУ им. аль-Фараби. Менторство от лидеров индустрии, акселерация, прямой выход на инвесторов.",
    ...
    "about.exp.title": "Экспертиза", "about.exp.desc": "Менторы из бизнеса и платформа для построения стартапов.",
    ...
    "prog.1.title": "Прибытие гостей и регистрация", "prog.1.desc": "Регистрация участников по месту, приветственный coffee point",
    "prog.2.title": "Выступления спикеров", "prog.2.desc": "Проректор КазНУ, директор Farabi Tech Hub, партнёры инкубатора, представители Qazaq IT Community, Human Capital, Technovation, Women in Tech",
    "prog.3.title": "Подписание меморандумов", "prog.3.desc": "Торжественная церемония подписания 5 меморандумов о сотрудничестве",
    "prog.4.title": "Торжественное открытие", "prog.4.desc": "Разрезание красной ленты. Официальное открытие пространства Farabi Tech Hub",
    "prog.5.title": "Mini Campus Tour", "prog.5.desc": "Презентация стартап-проектов, рабочих зон хаба и направлений деятельности инкубатора",
    "prog.6.title": "Networking & фуршет", "prog.6.desc": "Нетворкинг для гостей, партнёров, студентов и представителей стартап-экосистемы",
    ...
    "ben.incub.title": "Инкубация", "ben.incub.desc": "Полный цикл развития стартапа: от валидации идеи до MVP",
    "ben.accel.title": "Акселерация", "ben.accel.desc": "Менторы из бизнеса и прямой выход на инвесторов",
  ...
  kz: {
    ...
    "about.desc": "Farabi Tech Hub — Қазақстандағы алғашқы университеттік бизнес-инкубатор, ҚазҰУ негізінде құрылған. Сала көшбасшыларынан менторлық, акселерация, инвесторларға тікелей қол жеткізу.",
    ...
    "about.exp.title": "Сараптама", "about.exp.desc": "Бизнестен менторлар және стартаптар құруға арналған платформа.",
    ...
    "prog.1.title": "Қонақтарды қарсы алу және тіркелу", "prog.1.desc": "Орнында тіркелу, қарсы алу coffee point",
    "prog.2.title": "Спикерлердің сөз сөйлеуі", "prog.2.desc": "ҚазҰУ проректоры, Farabi Tech Hub директоры, инкубатор серіктестері, Qazaq IT Community, Human Capital, Technovation, Women in Tech өкілдері",
    "prog.3.title": "Меморандумдарға қол қою", "prog.3.desc": "5 ынтымақтастық меморандумына салтанатты түрде қол қою рәсімі",
    "prog.4.title": "Салтанатты ашылу", "prog.4.desc": "Қызыл лента кесу. Farabi Tech Hub кеңістігін ресми ашу",
    "prog.5.title": "Mini Campus Tour", "prog.5.desc": "Стартап жобалары, хабтың жұмыс аймақтары мен инкубатор қызметі бағыттарын таныстыру",
    "prog.6.title": "Networking & фуршет", "prog.6.desc": "Қонақтар, серіктестер, студенттер және стартап-экожүйе өкілдері үшін нетворкинг",
    ...
    "ben.incub.title": "Инкубация", "ben.incub.desc": "Стартапты дамытудың толық циклі: идеяны валидациялаудан MVP-ге дейін",
    "ben.accel.title": "Акселерация", "ben.accel.desc": "Бизнестен менторлар және инвесторларға тікелей шығу",
  ...
  en: {
    ...
    "about.desc": "Farabi Tech Hub is the first university-based business incubator in Kazakhstan, created at Al-Farabi KazNU. Mentorship from industry leaders, acceleration, direct access to investors.",
    ...
    "about.exp.title": "Expertise", "about.exp.desc": "Business mentors and a platform for building startups.",
    ...
    "prog.1.title": "Guest Arrival & Registration", "prog.1.desc": "On-site registration, welcome coffee point",
    "prog.2.title": "Speaker Presentations", "prog.2.desc": "KazNU Vice-Rector, Farabi Tech Hub Director, incubator partners, representatives of Qazaq IT Community, Human Capital, Technovation, Women in Tech",
    "prog.3.title": "Memorandum Signing", "prog.3.desc": "Ceremonial signing of 5 cooperation memorandums",
    "prog.4.title": "Grand Opening Ceremony", "prog.4.desc": "Ribbon cutting. Official opening of Farabi Tech Hub",
    "prog.5.title": "Mini Campus Tour", "prog.5.desc": "Presentation of startup projects, hub workspaces and incubator activities",
    "prog.6.title": "Networking & Reception", "prog.6.desc": "Networking for guests, partners, students and startup ecosystem representatives",
    ...
    "ben.incub.title": "Incubation", "ben.incub.desc": "Full startup development cycle: from idea validation to MVP",
    "ben.accel.title": "Acceleration", "ben.accel.desc": "Business mentors and direct investor access",
