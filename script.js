...
const i18n = {
  ru: {
    ...
    "prog.1.title": "Сбор гостей", "prog.1.desc": "Регистрация, приветственный кофе, знакомство с резидентами и командой инкубатора",
  ...
  kz: {
    ...
    "prog.1.title": "Қонақтар жиналуы", "prog.1.desc": "Тіркелу, қарсы алу кофесі, резиденттермен және инкубатор командасымен танысу",
  ...
  en: {
    ...
    "prog.1.title": "Guest Registration", "prog.1.desc": "Registration, welcome coffee, meeting residents and the incubator team",
